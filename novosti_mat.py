...
"""
if not os.path.exists("/var/current_content.txt"):
    with open("/var/current_content.txt", 'w'):
        pass
        
        
# read previous website content from file
with open("/var/current_content.txt", 'r', encoding='utf-8') as f:
...
if str(current_content) != previous_content:
    ...
    with open("/var/current_content.txt", 'w', encoding='utf-8') as f:
